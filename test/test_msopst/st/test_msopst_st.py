...
# 动态加载模块
loader = importlib.machinery.SourceFileLoader("msopst", str(op_test_frame_path))
...
ST_GOLDEN_OP_RESULT_TXT = './test_msopst/st/golden/base_case/input/result.txt'
ST_GOLDEN_ABNORMAL_CASE_JSON_INPUT = './test_msopst/st/golden/base_case/input/test_add_abnormal_case.json'
ST_GOLDEN_ATC_FAILED_JSON_INPUT = './test_msopst/st/golden/base_case/input/test_add_when_atc_failed.json'

# AICPU_PARSE_HEAD_FILE OUTPUT
BUCKETIZE_INI_INPUT = (
    './test_msopst/st/golden/base_case/golden_output/aicpu/cpukernel/op_info_cfg/aicpu_kernel/bucketize.ini'
)
TOPK_INI_INPUT = './test_msopst/st/golden/base_case/golden_output/aicpu/cpukernel/op_info_cfg/aicpu_kernel/top_k.ini'
LESS_INI_INPUT = './test_msopst/st/golden/base_case/golden_output/aicpu/cpukernel/op_info_cfg/aicpu_kernel/less.ini'
CAST_INI_INPUT = './test_msopst/st/golden/base_case/golden_output/aicpu/cpukernel/op_info_cfg/aicpu_kernel/cast.ini'
AICPU_CASE_JSON_GOLDEN_OUTPUT = './test_msopst/st/golden/base_case/golden_output/aicpu/json'

# paramType: optional OUTPUT
OPTIONAL_INI_INPUT = './test_msopst/st/golden/base_case/input/Pooling.ini'
OPTIONAL_ST_GOLDEN_OUTPUT = './test_msopst/st/golden/base_case/golden_output/optional_input'
ST_GOLDEN_OP_CASE_JSON_INPUT = './test_msopst/st/golden/base_case/input/Pooling_case_20210225145706.json'
ST_GOLDEN_ACL_PROJECT_OUTPUT_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/Pooling/src/testcase.cpp'
)
ST_GOLDEN_ACL_PROJECT_ORIGIN_OUTPUT_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/Pooling/src/testcase_ori.cpp'
)
ST_GOLDEN_ACL_PROJECT_OUTPUT_RUN = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/Pooling/run/out/test_data/config/'
)
MSOPST_CONF_INI = './test_msopst/st/golden/base_case/input/msopst.ini'

# dynamic shape
ST_GOLDEN_OP_DYNAMIC_SHAPE_INI_INPUT = './test_msopst/st/golden/base_case/input/add.ini'

ST_GOLDEN_OP_DYNAMIC_SHAPE_JSON_INPUT = './test_msopst/st/golden/base_case/input/add_case.json'
ST_GOLDEN_DYNAMIC_SHAPE_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/Add/src/testcase.cpp'
)

# MINDSPORE OPERATOR INPUT/OUTPOUT
ST_MS_GOLDEN_JSON_OUTPUT = './test_msopst/st/golden/base_case/golden_output/mindspore/json'
ST_MS_GOLDEN_INPUT_JSON = './test_msopst/st/golden/base_case/input/ms_st_report.json'

ST_GOLDEN_OP_GEN_WITH_VALUE_JSON_INPUT = './test_msopst/st/golden/base_case/input/test_value_add.json'
ST_GOLDEN_OP_GEN_WITH_VALUE_ACL_PROJECT_OUTPUT = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/Adds/src/testcase.cpp'
)
...
ST_GOLDEN_OP_FUZZ_CASE_JSON_INPUT = './test_msopst/st/golden/base_case/input/test_add_fuzz.json'
ST_GOLDEN_OP_FUZZ_CASE_OUTPUT_SRC = './test_msopst/st/golden/base_case/golden_output/fuzz/Add/src/testcase.cpp'
ST_GOLDEN_OP_FUZZ_CASE_OUTPUT_RUN = './test_msopst/st/golden/base_case/golden_output/fuzz/Add/run/out/test_data/config/'
ST_GOLDEN_MS_FUZZ_CASE_JSON_INPUT = './test_msopst/st/golden/base_case/input/ms_case_fuzz.json'
ST_GOLDEN_MS_FUZZ_CASE_OUTPUT_SRC = './test_msopst/st/golden/base_case/golden_output/fuzz/Square/src'
# const input
ST_GOLDEN_CONST_INPUT_VALUE_JSON = './test_msopst/st/golden/base_case/input/const_input_with_value.json'
ST_GOLDEN_CONST_INPUT_DATA_DISTRIBUTE_JSON = (
    './test_msopst/st/golden/base_case/input/const_input_with_data_distribute.json'
)
ST_GOLDEN_CONST_INPUT_NO_VALUE_JSON = './test_msopst/st/golden/base_case/input/const_input_with_no_value.json'
ST_GOLDEN_SCALAR_INPUT_WITH_VALUE_JSON = './test_msopst/st/golden/base_case/input/scalar_input_with_value.json'
# attr support data type
ST_GOLDEN_ATTR_SUPPORT_DATA_TYPE_JSON = './test_msopst/st/golden/base_case/input/test_attr_support_data_type.json'
ST_GOLDEN_ATTR_SUPPORT_DATA_TYPE_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/TestOp/testcase.cpp'
)
ST_GOLDEN_ATTR_SUPPORT_DATA_TYPE_ACL_JSON = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/TestOp/acl_op.json'
)
# const input golden files.
ST_GOLDEN_CONST_INPUT_SRC_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/ResizeBilinearV2/src/testcase.cpp'
)
ST_GOLDEN_CONST_INPUT_SRC_OP_EXECUTE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/ResizeBilinearV2/src/op_execute.cpp'
)
ST_GOLDEN_CONST_INPUT_CONFIG_ACL_OP = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/ResizeBilinearV2/config/acl_op.json'
)
ST_GOLDEN_SCALAR_INPUT_SRC_TESTCASE = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/const_input/TestScalar/testcase.cpp'
)
ST_GOLDEN_SCALAR_INPUT_CONFIG_ACL_OP = (
    './test_msopst/st/golden/base_case/golden_output/gen_optional_acl_prj/const_input/TestScalar/acl_op.json'
)
...
class TestUtilsMethods(unittest.TestCase):
        ...
        with pytest.raises(SystemExit) as error:
            with mock.patch('sys.argv', args):
                with (
                    ...
                    msopst.main()
        self.assertEqual(error.value.code, ConstManager.OP_TEST_GEN_INVALID_PATH_ERROR)
    ...
    def test_model_parser_1(self):
        ...
        with pytest.raises(utils.OpTestGenException) as error:
            tf_model_parser = TFModelParse(args)  # pylint: disable=redefined-outer-name
    ...
    def test_get_info_from_model_fun(self):
        ...
        attr_list = [{'name': 'data_format', 'type': 'string', 'value': 'NHWC'}]
        base_case = {
            'case_name': 'Test_XXX_sub_case_001',
            'op': 'Conv2D',
            'input_desc': [
                {
                    'format': ['NHWC'],
            ...
            'output_desc': [{'format': ['NHWC'], 'type': 'float', 'shape': [[1, 1, 1, 1000]], 'name': 'y'}],
        }
    ...
    def test_model_parser_2(self):
        ...
        with mock.patch('msopst.st.interface.framework.tf_model_parser.input', return_value='n'):
            tf_model_parser = TFModelParse(args)  # pylint: disable=redefined-outer-name
            tf_model_parser.get_tf_model_nodes("Conv2D")
    ...
    def test_model_parser_3(self):
        ...
        self.assertEqual(error.value.args[0], ConstManager.OP_TEST_GEN_TF_CHANGE_PLACEHOLDER_ERROR)
    ...
    def test_model_parser_6(self):
        ...
        in tf_model_parser.py
        """
        tf_dtype_list = ["float32", "float16", "int8", "int16", "int32", "uint8", "uint16", "uint32", "bool", "int64"]
    ...
    def test_model_parser_7(self):
        ...
        self.assertEqual(error.value.args[0], ConstManager.OP_TEST_GEN_TF_LOAD_ERROR)
    ...
    def test_model_parser_new_shape_error(self):
        ...
        """
        args = Args('./a.json', '', MODEL_ARGS)
        lines = '{"Placeholder": {"ori_shape": [-1, 224, 224, 3], "new_shape": ["a", "b"]}}'

        class NodeMock(object):  # pylint: disable=useless-object-inheritance
            op = "Placeholder"
            name = "Placeholder"

        class GraphMock(object):  # pylint: disable=useless-object-inheritance
            node = [NodeMock]

        with pytest.raises(utils.OpTestGenException) as error:
            with mock.patch(
                'msopst.st.interface.framework.tf_model_parser._tf_utils_load_graph_def', return_value=GraphMock
            ):
                with mock.patch('msopst.st.interface.utils.check_path_valid'):
                    with mock.patch('builtins.open', mock.mock_open(read_data=lines)):
                        with mock.patch('os.open') as open_file, mock.patch('os.fdopen'):
                ...
                with mock.patch('os.path.exists', return_value=True), mock.patch('os.chdir'):
                    with mock.patch('os.access', return_value=True):
                        with mock.patch('os.path.join', return_value=ST_GOLDEN_OP_RESULT_TXT):
                            with mock.patch(
                                'msopst.st.interface.st_report.OpSTReport.get_case_report', return_value=op_st_report
                            ):
                ...
                with mock.patch('os.path.exists', return_value=True), mock.patch('os.chdir'):
                    with mock.patch('os.access', return_value=True):
                        with mock.patch('os.listdir', return_value='AddN'):
                            with mock.patch('os.path.join', return_value=ST_GOLDEN_OP_RESULT_TXT):
                                with mock.patch(
                                    'msopst.st.interface.st_report.OpSTReport.get_case_report',
    ...
    def test_gen_data_2(self):
        ...
        report = OpSTReport()
        data_generator = DataGenerator([], '/home', True, report)
        data_distribution = ['uniform', 'normal', 'beta', 'laplace', 'triangular', 'sigmoid', 'softmax', 'tanh']
        for distribution in data_distribution:
            data = data_generator.gen_data([2, 4], -10, 400, 'float', distribution)
    ...
    def test_profiling_analysis_1(self):
        ...
        report = OpSTReport()
        runner = AclOpRunner('/home', 'ddd', report)
        runner._get_op_case_result_and_show_data(csv_file, op_name_list)
    ...
    def test_profiling_op_name_list_fail(self):
        ...
        report = OpSTReport()
        runner = AclOpRunner('/home', 'ddd', report)
        runner._prof_get_op_case_info_from_csv_file(csv_file, op_name_list)
    ...
    def test_profiling_analysis_2(self):
        ...
        op_st_case_trace = OpSTCaseTrace(op_st)
        op_st_report = OpSTCaseReport(op_st_case_trace)
        with mock.patch('msopst.st.interface.st_report.OpSTReport.get_case_report', return_value=op_st_report):
            runner = AclOpRunner('/home', 'ddd', report)
    ...
    def test_prof_analyze(self):
        ...
        lines = (
            "1  Test_AddN_001_case_001  [pass] \n "
            "2  Test_AddN_001_case_002  [pass] \n "
            "3  Test_AddN_001_case_003  [pass] \n"
        )
        report = OpSTReport()
        runner = AclOpRunner('/home', 'ddd', report)
        with mock.patch('msopst.st.interface.utils.ScanFile.scan_subdirs', return_value=['result.txt']):
            with mock.patch('msopst.st.interface.utils.read_file', return_value=lines):
                with (
                    mock.patch('os.path.join', return_value=out_path),
                    mock.patch('os.path.exists', return_value=True),
                    mock.patch('os.access', return_value=True),
                    mock.patch('os.chdir'),
                ):
        ...
        with mock.patch('os.path.exists', return_value=True):
            with mock.patch('os.path.isdir', return_value=True):
                with mock.patch('os.path.split', return_value=["PROF_A", "device_0"]):
                    with mock.patch('os.listdir', return_value=["PROF_A/device_0"]):
                        scan.scan_subdirs()
    ...
    def test_st_report_save(self):
        ...
        with mock.patch('msopst.st.interface.st_report.OpSTReport._to_json_obj', return_value=[{}]):
    ...
    def test_create_cmd_for_mindspore(self, getattr_mock):
        ...
        op_info = {
            'op_name': 'Square',
            'inputs': [{'index': 0, 'name': 'x', 'need_compile': False, 'param_type': 'required', 'shape': 'all'}],
            'outputs': [{'index': 0, 'name': 'y', 'need_compile': False, 'param_type': 'required', 'shape': 'all'}],
            'attr': [],
            'fusion_type': 'OPAQUE',
            'dtype_format': [(('float32', 'DefaultFormat'), ('float32', 'DefaultFormat'))],
            'imply_type': 'TBE',
            'async_flag': False,
        ...
        with pytest.raises(SystemExit):
            with mock.patch('sys.argv', args):
                with mock.patch('msopst.st.interface.utils.check_path_valid'):
                    with mock.patch('msopst.st.interface.utils.check_input_permission_valid'):
                        with mock.patch('builtins.open', mock.mock_open(read_data=lines)):
                            with mock.patch(
                                'msopst.st.interface.case_generator.CaseGenerator._get_ms_ops_info',
                                return_value=op_info,
                            ):
                                with mock.patch(
                                    'msopst.st.interface.arg_parser.MsopstArgParser._check_path_permission_valid',
                                    return_value=None,
                                ):
                                    msopst.main()

        self.assertTrue(test_utils.check_file_context(ST_OUTPUT, ST_MS_GOLDEN_JSON_OUTPUT))
        ...
        data = [
            {
                ...
                "calc_expect_func_file": "/home/aa.py:calc_expect_func",
                "input_desc": [
                    {
                        "format": ["NC1HWC0"],
                        "ori_format": ["NCHW"],
    ...
    @staticmethod
    def mock_gen_data(cls, *args, **kwargs):  # pylint: disable=bad-staticmethod-argument
        """mock tofile"""
        return NumpyArrar()
    ...
    def test_abnormal_case(self):
        ...
        """
        test_utils.clear_out_path(ST_OUTPUT)
        args = ['msopst', 'run', '-i', ST_GOLDEN_ABNORMAL_CASE_JSON_INPUT, '-soc', 'Ascend310', '-out', ST_OUTPUT]
        with pytest.raises(SystemExit):
            with mock.patch('sys.argv', args):
                with mock.patch('msopst.st.interface.utils.execute_command'):
                    msopst.main()
    ...
    def test_interrupt_process_when_atc_failed(self):
        ...
        """
        test_utils.clear_out_path(ST_OUTPUT)
        args = ['msopst', 'run', '-i', ST_GOLDEN_ATC_FAILED_JSON_INPUT, '-soc', 'Ascend310', '-out', ST_OUTPUT]
        with pytest.raises(SystemExit):
            with mock.patch('sys.argv', args):
                msopst.main()
    ...
    def test_check_list_float_error(self):
        ...
        self.assertEqual(error.value.args[0], ConstManager.OP_TEST_GEN_INVALID_ERROR_THRESHOLD_ERROR)

    def test_clas_report_json_encoder(self):
        value1 = np.int8(1)
        value2 = np.float16(1.0)
        value4 = np.zeros(5)
        json_obj = {"value1": [value1], "value2": [value2], "value3": [(1.000000066 + 0j)], "value4": [value4]}
    ...
    def test_st_torch_api(self):
        ...
        """
        test_utils.clear_out_path(ST_OUTPUT)
        self.gen_data_ = DataGenerator.gen_data  # pylint: disable=attribute-defined-outside-init
        DataGenerator.gen_data = staticmethod(self.mock_gen_data)
        args = ['msopst', 'run', '-i', ST_PT_GOLDEN_INPUT_JSON, '-soc', 'Ascend910', '-out', ST_OUTPUT]
        with pytest.raises(SystemExit):
            with mock.patch('sys.argv', args):
                with mock.patch('msopst.st.interface.utils.execute_command'):
                    msopst.main()
        ...
        with mock.patch('os.getenv', return_value="/home"):
            with mock.patch('os.path.exists', return_value=True):
                with mock.patch(
                    ...
                    with mock.patch('msopst.st.interface.acl_op_runner.AclOpRunner._get_job_path', return_value='/aaa'):
                        with mock.patch('msopst.st.interface.utils.execute_command'):
                            with mock.patch('msopst.st.interface.utils.check_path_valid'):
                                with mock.patch('os.path.exists', return_value=True), mock.patch('os.chdir'):
                                    report = OpSTReport()
    ...
    def test_check_required_key_valid(self):
        ...
        with pytest.raises(utils.OpTestGenException) as error:
            utils.check_required_key_valid(json_obj1, ConstManager.REQUIRED_KEYS, 'case', '/home')
        self.assertEqual(error.value.args[0], ConstManager.OP_TEST_GEN_PARSE_JSON_FILE_ERROR)
        json_obj2 = {"run_torch_api": 'torch.aaa'}
        with pytest.raises(utils.OpTestGenException) as error:
            utils.check_required_key_valid(json_obj2, ConstManager.REQUIRED_KEYS, 'case', '/home')
        self.assertEqual(error.value.args[0], ConstManager.OP_TEST_GEN_PARSE_JSON_FILE_ERROR)
    ...
    def test_gen_ascendc_test_code(self):
        ...
        args = [
            ...
            'ascendc_test',
            '-i',
            ASCENDC_ST_CASE_JSON,
            '-kernel',
            ASCENDC_KERNEL_CPP_FILE,
            '-out',
            ST_OUTPUT,
        ]
        with pytest.raises(SystemExit):
