...
- 若要使用MindStudio Insight进行查看时，需要单独安装MindStudio Insight软件包，具体下载链接请参见《[MindStudio Insight工具用户指南](https://gitcode.com/Ascend/msinsight/blob/26.2.0/docs/zh/install_guide/mindstudio_insight_install_guide.md)》的"安装指南"章节。
