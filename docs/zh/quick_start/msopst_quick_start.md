# msOpST算子测试工具快速入门<a id="ZH-CN_TOPIC_0000002539355243"></a>

## 1. 简介<a id="section040515232197"></a>

MindStudio Ops System Test（算子测试工具，msOpST）工具用于算子开发完成后，对算子功能进行初步测试，该工具可以更加高效地进行算子性能的分析和优化，提高算子的执行效率，降低开发成本。

本样例基于AscendCL接口的流程，生成单算子的OM文件，并执行该文件以验证算子执行结果的正确性。

## 2. 环境准备<a id="section81731814530"></a>
...
## 3. 操作步骤<a id="section1587411211202"></a>
