...
This document assumes that you have completed all operations in <a href="https://gitcode.com/Ascend/msot/blob/26.0.0/docs/en/quick_start/op_tool_quick_start.md" target="_blank">Quick Start of Operator Development Tools</a>. If you have not done so, complete that guide first for a better learning experience.
...
For details about the error code description, see [ACL Error Code Table](https://www.hiascend.com/document/detail/en/CANNCommunityEdition/900/API/ascendgraphapi/aclcppge_00_0010.html).
